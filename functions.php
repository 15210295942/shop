...
echo "<td><strong>&euro;" . sprintf('%.2f', $itemsrow['price']) . "</strong></td>";
echo "<td><strong>&euro;". sprintf('%.2f', $quantitytotal) . "</strong></td>";
...
echo "<td></td>";
echo "<td>TOTAL</td>";
echo "<td><strong>&euro;". sprintf('%.2f', $total) . "</strong></td>";
echo "<td></td>";
echo "</tr>";
echo "</table>";
}
